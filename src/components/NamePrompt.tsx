...
export function NamePrompt({ onSubmit }: { onSubmit: (name: string) => void }) {
  ...
  return (
    <div className="mt-8 bg-white/90 backdrop-blur rounded-3xl shadow-xl p-8 sm:p-10 border-2 border-white">
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl font-display font-bold text-slate-800 mb-2">Welcome, friend!</h2>
        <p className="text-slate-600">What should your teammates call you?</p>
      </div>
      <form
